...
import "../../components/corousel/carousel.css";
import { makeStyles, useTheme } from "@material-ui/core/styles";
import SwipeableViews from "react-swipeable-views";
import { autoPlay } from "react-swipeable-views-utils";
import ICMS from "../../images/icms.png";
            ...
            <div className="row p-5">
              <div className=" col-12 carousel-sub-category-content-main2 ">
                <div className=" d-flex">
                  ...
                  {/* <div className="carousel-date">{tutorialSteps[activeStep].calender}  <span className='carousel-btn-date'>{tutorialSteps[activeStep].date}</span></div> */}
                </div>
                <div className="pt-3">
